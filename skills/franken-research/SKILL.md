...
- Route to `references/research-execution.md`
...
5. **Generate `research_docs/research_prompt.md`** — populate the template from `references/prompt-template.md` with interview answers and landscape data
...
See `references/research-execution.md` for the full 4-phase methodology.
...
See `assets/example_research_prompt.md` for an example of what a generated research prompt looks like.
...
- **`references/research-execution.md`** — 4-phase deep dive methodology: orientation, parallel exploration, synthesis, document writing with recommended sections and quality standards
- **`references/prompt-template.md`** — Skeleton template for generated research prompts with placeholder sections
