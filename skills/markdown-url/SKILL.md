---
name: markdown-url
description: Route website visits through markdown.new for clean Markdown extraction. Use when reading docs, blog posts, changelogs, GitHub issues, or any web content where you need extractable text. Prefixes URLs with https://markdown.new/ automatically.
---
...
```bash
node ~/.agent/skills/markdown-url/scripts/markdown-url.js "https://example.com/docs"
```
